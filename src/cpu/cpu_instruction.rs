...
impl CpuInstruction {
    ...
    pub fn decode(opcode: u8) -> Self {
        match opcode {
            ...
            0x43 => Self::new(Instruction::Sre, AddressingMode::IndexedIndirect),
            0x44 => Self::new(Instruction::Nop, AddressingMode::ZeroPage),
            0x47 => Self::new(Instruction::Sre, AddressingMode::ZeroPage),
            0x4F => Self::new(Instruction::Sre, AddressingMode::Absolute),
            0x53 => Self::new(Instruction::Sre, AddressingMode::IndirectIndexed),
            0x54 => Self::new(Instruction::Nop, AddressingMode::ZeroPageX),
            0x57 => Self::new(Instruction::Sre, AddressingMode::ZeroPageX),
            0x5A => Self::new(Instruction::Nop, AddressingMode::Implicit),
            0x5B => Self::new(Instruction::Sre, AddressingMode::AbsoluteY),
            0x5C => Self::new(Instruction::Nop, AddressingMode::AbsoluteX),
            0x5F => Self::new(Instruction::Sre, AddressingMode::AbsoluteX),
            0x63 => Self::new(Instruction::Rra, AddressingMode::IndexedIndirect),
            0x64 => Self::new(Instruction::Nop, AddressingMode::ZeroPage),
            0x67 => Self::new(Instruction::Rra, AddressingMode::ZeroPage),
            0x6F => Self::new(Instruction::Rra, AddressingMode::Absolute),
            0x73 => Self::new(Instruction::Rra, AddressingMode::IndirectIndexed),
            0x74 => Self::new(Instruction::Nop, AddressingMode::ZeroPageX),
            0x77 => Self::new(Instruction::Rra, AddressingMode::ZeroPageX),
            0x7A => Self::new(Instruction::Nop, AddressingMode::Implicit),
            0x7B => Self::new(Instruction::Rra, AddressingMode::AbsoluteY),
            0x7C => Self::new(Instruction::Nop, AddressingMode::AbsoluteX),
            0x7F => Self::new(Instruction::Rra, AddressingMode::AbsoluteX),
